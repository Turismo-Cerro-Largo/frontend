...
<section class="flex items-center justify-center w-full min-h-dvh px-4">
    <div class="w-full max-w-sm">
        ...
        <form class="flex flex-col gap-4">
            ...
            <button type="submit" class="h-11 bg-green-600 hover:bg-green-700 active:scale-98 transition-all cursor-pointer text-white font-medium rounded-lg"> Ingresar </button>
