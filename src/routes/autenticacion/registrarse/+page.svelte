    ...
    <div class="w-full max-w-sm">
        ...
        <form enctype="multipart/form-data" class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-1">
                ...
                <input id="email" name="email" type="email" required class="rounded-lg border-slate-300 text-slate-800 focus:border-green-600 focus:ring-green-600" />
            </div>
            ...
            <div class="flex flex-col gap-1">
                ...
                <select id="genero" name="genero" required class="rounded-lg border-slate-300 text-slate-800 focus:border-green-600 focus:ring-green-600">
            ...
            <div class="flex flex-col gap-1">
                <label for="localidad" class="text-sm font-medium text-slate-700"> Localidad </label>
                <select id="localidad" name="localidad" required class="rounded-lg border-slate-300 text-slate-800 focus:border-green-600 focus:ring-green-600">
                    <option value="" disabled selected>Seleccioná una localidad</option>
            ...
            <div class="flex flex-col gap-1">
                <label for="fechaNacimiento" class="text-sm font-medium text-slate-700"> Fecha de nacimiento </label>
                <input
                    id="fechaNacimiento"
                    name="fechaNacimiento"
                    type="date"
                    max={metodo === 'organizador' ? fechaMaximaMayorEdad : undefined}
                    required
                    class="rounded-lg border-slate-300 text-slate-800 focus:border-green-600 focus:ring-green-600"
                />
            </div>
            ...
            {#if metodo === 'organizador'}
                <div transition:slide={{ duration: 250 }} class="flex flex-col gap-4 p-4 bg-slate-50 border border-slate-200 rounded-xl overflow-hidden">
                    ...
                    <div class="flex flex-col gap-1">
                        <label for="cedula" class="text-sm font-medium text-slate-700"> Cédula de Identidad </label>
                        <input
                            id="cedula"
                            name="cedula"
                            type="text"
            ...
            <button type="submit" class="h-11 bg-green-600 hover:bg-green-700 active:scale-98 transition-all cursor-pointer text-white font-medium rounded-lg mt-2">
                Registrarse
            </button>
